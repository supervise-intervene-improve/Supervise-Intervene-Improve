...
{
    DepthTestedOpaque  = 0,   // opaque cubes, ZWrite On, renderQueue 2000
    OverlayTransparent = 1,   // transparent blend, ZWrite Off, ZTest Always
    OverlayDepthWrite  = 2,   // transparent blend + ZWrite On + ZTest LessEqual (ATW-stable)
}
