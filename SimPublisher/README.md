...
In this repository it is used together with the Meta Quest 3 application in [`SII-Meta-Quest3/`](../SII-Meta-Quest3).
...
- Meta Quest 3 (see [`SII-Meta-Quest3/`](../SII-Meta-Quest3))
- HoloLens 2

## Installation
This copy is bundled with the repository. Install it from the repository root:
```bash
...
1. Build and deploy the Unity application in [`SII-Meta-Quest3/`](../SII-Meta-Quest3) to your headset.
